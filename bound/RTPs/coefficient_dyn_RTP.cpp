...
/*define variables and vectors*/
	...
	double Pe = atof(argv[2]);//bonding energy for 2grb2 to 
    double gamma1=atof(argv[4]);
    //sos and 2 sos to L.
...
/*calculate the observable*/
        ...
        //printf("%lf %lf %lf %lf\n",i*h,flux/(i*h)/(Pe*Pe),fluxp/N/(i*h),lams*flux/(Pe*Pe)/(i*h));
         //fprintf(den1,"%lf %lf %lf\n",i*h,flux/(Pe*Pe)/(i*h),lams*flux/(Pe*Pe)/(i*h));
